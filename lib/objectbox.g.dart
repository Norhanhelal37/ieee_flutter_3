...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      id: const obx_int.IdUid(1, 8238021601744438049),
      name: 'TaskModel',
      lastPropertyId: const obx_int.IdUid(3, 4860053877306089033),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 3918494983271368200),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 1953179483299732397),
            name: 'title',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 4860053877306089033),
            name: 'cagt',
            type: 9,
            flags: 0)
      ],
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(1, 8238021601744438049),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    TaskModel: obx_int.EntityDefinition<TaskModel>(
        ...
        objectToFB: (TaskModel object, fb.Builder fbb) {
          ...
          final cagtOffset = fbb.writeString(object.cagt);
          fbb.startTable(4);
          fbb.addInt64(0, object.id);
          fbb.addOffset(1, titleOffset);
          fbb.addOffset(2, cagtOffset);
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final cagtParam = const fb.StringReader(asciiOptimization: true)
              .vTableGet(buffer, rootOffset, 8, '');
          final object =
              TaskModel(id: idParam, title: titleParam, cagt: cagtParam);
